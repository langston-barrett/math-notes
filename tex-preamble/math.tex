...
\DeclareMathOperator{\Inn}{Inn}         % algebra: inner automorphisms
\DeclareMathOperator{\Out}{Out}         % algebra: outer automorphisms
...
\DeclareCategory{\omegacat}{\omega} % categories: functor algebras
\DeclareCategory{\Pre}{Pre}       % categories: preorder category
